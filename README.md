...
La aplicación permite a los usuarios navegar el catálogo desde el celular, seleccionar un producto y personalizarlo mediante distintas opciones (tamaño, sabor, relleno, decoración y extras). Una vez confirmado el armado, el sistema genera automáticamente un mensaje estructurado con el detalle del pedido y redirige al usuario a WhatsApp, donde se completa la comunicación y confirmación del pedido de forma directa con el vendedor.

El proyecto no incluye pasarela de pagos, ya que el objetivo es facilitar el contacto, reducir costos operativos y mantener una experiencia simple y accesible para emprendimientos pequeños o medianos.
